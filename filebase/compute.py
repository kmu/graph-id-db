...
def compute_graphids(cif: str, data_source: str, data_source_id: str, data_source_url: str, out_dir="."):
    ...
    # TODO(@kamabata): Distance clusteringも入れる  # noqa: TD003, FIX002
    json_dict = {
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dir", type=str, required=True, help="Directory containing CIF files")
    parser.add_argument("--data_source", type=str, required=True, help="Data source")
    parser.add_argument("--data_source_url", type=str, required=True, help="Data source URL")
    parser.add_argument("--out_dir", type=str, default=".", help="Output directory for JSON files")
    ...
    if not cif_dir.exists():
        raise ValueError(f"Directory {cif_dir} does not exist")
